#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('c:\\Users\\Mahmoud Waleed\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.461\\out\\buildHook\\index.js').default({tool: 'live-server', checkSum: '20b123a3e61ca3ade06adcUx8AHVMJBAdQBwUEVVcHVQZQUlpa', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/Mahmoud%20Waleed/.vscode/extensions/wallabyjs.console-ninja-1.0.461/out/buildHook/index.js').then(m => m.default.default({tool: 'live-server', checkSum: '20b123a3e61ca3ade06adcUx8AHVMJBAdQBwUEVVcHVQZQUlpa', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
